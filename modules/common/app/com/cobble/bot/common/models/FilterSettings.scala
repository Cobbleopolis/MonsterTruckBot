...
case class FilterSettings(guildId: String, capsFilterEnabled: Boolean = false, capsFilterThreshold: Int = 20) extends Model {
...
object FilterSettings extends ModelAccessor[FilterSettings, String] {
